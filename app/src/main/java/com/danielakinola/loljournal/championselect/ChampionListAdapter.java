...
public class ChampionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    final private int[] championSquares = {
            ...
            R.drawable.leblanc_loading, R.drawable.leesin_loading, R.drawable.leona_loading,
            R.drawable.lissandra_loading, R.drawable.lucian_loading, R.drawable.lulu_loading,
            R.drawable.lux_loading, R.drawable.malphite_loading, R.drawable.malzahar_loading,
            R.drawable.maokai_loading, R.drawable.masteryi_loading, R.drawable.missfortune_loading,
            R.drawable.mordekaiser_loading, R.drawable.morgana_loading, R.drawable.nami_loading,
            R.drawable.nasus_loading, R.drawable.nautilus_loading, R.drawable.nidalee_loading,
            R.drawable.nocturne_loading, R.drawable.nunu_loading, R.drawable.olaf_loading,
            R.drawable.orianna_loading, R.drawable.ornn_loading, R.drawable.pantheon_loading,
            R.drawable.poppy_loading, R.drawable.pyke_loading, R.drawable.quinn_loading,
            R.drawable.rakan_loading, R.drawable.rammus_loading, R.drawable.reksai_loading,
            R.drawable.renekton_loading, R.drawable.rengar_loading, R.drawable.riven_loading,
            R.drawable.rumble_loading, R.drawable.ryze_loading, R.drawable.sejuani_loading,
            R.drawable.shaco_loading, R.drawable.shen_loading, R.drawable.shyvana_loading,
            R.drawable.singed_loading, R.drawable.sion_loading, R.drawable.sivir_loading,
            R.drawable.skarner_loading, R.drawable.sona_loading, R.drawable.soraka_loading,
            R.drawable.swain_loading, R.drawable.syndra_loading, R.drawable.tahmkench_loading,
            R.drawable.taliyah_loading, R.drawable.talon_loading, R.drawable.taric_loading,
            R.drawable.teemo_loading, R.drawable.thresh_loading, R.drawable.tristana_loading,
            R.drawable.trundle_loading, R.drawable.tryndamere_loading, R.drawable.twistedfate_loading,
            R.drawable.twitch_loading, R.drawable.udyr_loading, R.drawable.urgot_loading,
